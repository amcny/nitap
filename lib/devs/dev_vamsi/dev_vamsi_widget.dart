...
class _DevVamsiWidgetState extends State<DevVamsiWidget> {
  late DevVamsiModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DevVamsiModel());
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        Expanded(
                          child: Text(
                            'Firebase Manager · Batch of 2022\nDepartment of Electronics & Communication',
                            textAlign: TextAlign.center,
                            style:
