...
import 'alert_deleteauth_model.dart';
export 'alert_deleteauth_model.dart';

class AlertDeleteauthWidget extends StatefulWidget {
...
class _AlertDeleteauthWidgetState extends State<AlertDeleteauthWidget> {
  late AlertDeleteauthModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AlertDeleteauthModel());
